...
```
The log-log model with all the continuous predictors included had the highest adjusted $R^2 $ of all the regressions run. This model setup can be interpreted as a percentage in x will have a 
