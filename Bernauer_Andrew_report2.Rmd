...
```{r}
 log_price_log_hash_rate <- ggplot(data = ether_df, aes(hash_rate, price)) +
  geom_point(color = "purple") 
  

 log_price_log_hash_rate
```

```{r}
 log_price_block_size <- ggplot(data = ether_df, aes(block_size, price)) +
  geom_point(color = "purple") 
  

 log_price_block_size
...
hist(ether_df$price)
hist(ether_df$transaction_history)
hist(ether_df$block_size)

hist(ether_df$hash_rate)

cor(ether_df[1:4])

log_price_trans_hist <- ggplot(data = ether_df, aes(transaction_history, price)) +
  geom_point(color = "purple") 
  

 log_price_trans_hist
