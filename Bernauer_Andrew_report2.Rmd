...
Ethereum data is quite complex on the surface level before the next report
...
```
The log-log model with all the continuous predictors included had the highest adjusted $R^2 $ of all the regressions run. A log-log model can be interpreted as a  
