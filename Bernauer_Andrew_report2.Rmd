...
log_price <- signedlog10(l_ether[[1]])

log_history <- signedlog10(l_ether[[2]])

log_block_size <- signedlog10(l_ether[[3]])

log_hash_rate <- signedlog10(l_ether[[4]])
