...
bagged.ether <- randomForest(price~., data = new_train_ether,
                             ntree=400, mtry=10/3, importance=TRUE)
bagged.ether
...
The Errors start to level off as you begun approaching 50 to 75 tree range. Increases the number of trees does not impact the error rate that much as the number of trees gets large. 
...
```{r}
round(mean((new_test_ether$price - yhat_bagged)^2), 2)
```
