...
```{r}
 boosted_mse <- round(mean(new_test_ether$price - yhat_xgboost)^2, 2)
 lasso_mse
 ridge_mse
 bagging_mse
 mse_random_forest
...
Transaction history displays an overwhelming level of relative importance for the xgboost model as shown above. With time or unix time stamp being the only other important variable.
