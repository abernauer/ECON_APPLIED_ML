...
ggplot() + geom_point(aes(x = new_test_ether$price, y = y_hat_rf_opt), color = "purple", alpha=0.5) + geom_abline(color = "yellow") + 
  labs(x="Ether Price", y="Random Forest estimation of Ether Price")
